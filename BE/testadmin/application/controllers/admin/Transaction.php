...
class Transaction extends MY_Controller {
	...
	public function detail()
	{
		...
		foreach ($info as $key => $value) {
			$this->db->select('product.id as id,product.name as name,image_link, oderr.qty as qty,oderr.amount as price, oderr.id as order_id');
			$this->db->join('oderr', 'oderr.product_id = product.id');
			$where = array();
