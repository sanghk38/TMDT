							...
							<tbody>
								<?php foreach ($product as $value) { ?>
									<tr>
										...
										<td><img src="<?php echo base_url(); ?>upload/product/<?php echo $value->image_link; ?>" alt="" style="width: 100px; height:100px; float:left;margin-right: 10px;"><strong><?php echo $value->name; ?></strong>
