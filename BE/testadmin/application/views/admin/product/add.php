		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Giá đã giảm</label>
						<div class="col-sm-5">

							<input type="text" name='price_new' class="form-control" id="inputEmail3" placeholder="" value="<?php echo set_value('price_new'); ?>"></input>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">Chi tiết</label>
						<div class="col-sm-8">
							<textarea class="form-control" rows="5" name="content" id='content'><?php echo set_value('content'); ?></textarea>
						</div>
					</div>
					<!-- <script>
